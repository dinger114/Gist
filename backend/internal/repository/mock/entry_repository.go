...
func (m *MockEntryRepository) ExistsByURL(ctx context.Context, feedID int64, url string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExistsByURL", ctx, feedID, url)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockEntryRepositoryMockRecorder) ExistsByURL(ctx, feedID, url any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
